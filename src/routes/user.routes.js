...
router.route('/update-avatar').patch(userVerification, upload.single('avatar'), userFunctions.updateAvatar);

router.route('/update-cover-image').patch(userVerification, upload.single('coverImage'), userFunctions.updateCoverImage);
